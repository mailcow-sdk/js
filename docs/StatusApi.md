...
let apiInstance = new MailcowSdkJs.StatusApi();
apiInstance.getContainerStatus((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new MailcowSdkJs.StatusApi();
apiInstance.getVersionStatus((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new MailcowSdkJs.StatusApi();
apiInstance.getVmailStatus((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
