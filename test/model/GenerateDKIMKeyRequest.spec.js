...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailcowSdkJs.GenerateDKIMKeyRequest();
  });
  ...
  describe('GenerateDKIMKeyRequest', function() {
    it('should create an instance of GenerateDKIMKeyRequest', function() {
      // uncomment below and update the code to test GenerateDKIMKeyRequest
      //var instance = new MailcowSdkJs.GenerateDKIMKeyRequest();
      //expect(instance).to.be.a(MailcowSdkJs.GenerateDKIMKeyRequest);
    });
