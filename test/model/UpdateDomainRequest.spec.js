...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailcowSdkJs.UpdateDomainRequest();
  });
  ...
  describe('UpdateDomainRequest', function() {
    it('should create an instance of UpdateDomainRequest', function() {
      ...
      //var instance = new MailcowSdkJs.UpdateDomainRequest();
      //expect(instance).to.be.a(MailcowSdkJs.UpdateDomainRequest);
    });
