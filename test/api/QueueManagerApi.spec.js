...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailcowSdkJs.QueueManagerApi();
  });
  ...
  describe('QueueManagerApi', function() {
    ...
    describe('flushQueue', function() {
      it('should call flushQueue successfully', function(done) {
        //uncomment below and update the code to test flushQueue
        //instance.flushQueue(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
