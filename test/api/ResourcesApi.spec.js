...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailcowSdkJs.ResourcesApi();
  });
  ...
  describe('ResourcesApi', function() {
    describe('createResources', function() {
      it('should call createResources successfully', function(done) {
        //uncomment below and update the code to test createResources
        //instance.createResources(function(error) {
